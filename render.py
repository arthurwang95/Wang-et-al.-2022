...
def linhao_gfp_render(name_pattern, proj_gfp, qual_gfp, cell_labels, average_gfp_pad, average_gfp_list,
    ...
    plt.imshow(cell_labels, cmap=plt.cm.nipy_spectral, interpolation='nearest')
    ...
    plt.imshow(gfp_outliers, cmap=plt.cm.nipy_spectral, interpolation='nearest')
...
def linhao_mch_render(name_pattern, proj_mCh, mitochondria, skeleton,
    ...
    plt.subplot(244)
    plt.imshow(skeleton, interpolation='nearest', cmap=plt.cm.nipy_spectral)
